...
import {
  useForm
} from "./chunk-5YPBMDBZ.js";
import {
  require_jsx_runtime
} from "./chunk-TMWECG2A.js";
import {
  require_react
} from "./chunk-DX3AZNQR.js";
import {
  __commonJS,
  __require,
  __toESM
  ...
  const memoizedSelect = (0, import_react13.useMemo)(() => {
    return (rawData) => {
      ...
      if (queryOptions2 == null ? void 0 : queryOptions2.select) {
        return (_a2 = queryOptions2 == null ? void 0 : queryOptions2.select) == null ? void 0 : _a2.call(queryOptions2, data);
      }
      return data;
    };
  }, [
...
var useUpdate = __name(({
  ...
  const mutationResult = useMutation({
    ...
    onSettled: (data, error, variables, context) => {
      ...
      (_a = mutationOptions2 == null ? void 0 : mutationOptions2.onSettled) == null ? void 0 : _a.call(mutationOptions2, data, error, variables, context);
    },
    ...
    onError: (err, variables, context) => {
      ...
      (_a = mutationOptions2 == null ? void 0 : mutationOptions2.onError) == null ? void 0 : _a.call(mutationOptions2, err, variables, context);
    },
...
var useCreateMany = __name(({
  ...
  const mutationResult = useMutation({
    ...
    onSuccess: (response, variables, context) => {
      ...
      (_a = mutationOptions2 == null ? void 0 : mutationOptions2.onSuccess) == null ? void 0 : _a.call(mutationOptions2, response, variables, context);
    },
    onError: (err, variables, context) => {
      var _a;
      const {
...
var useUpdateMany = __name(({
  ...
  const mutationResult = useMutation({
    ...
    onSuccess: (data, variables, context) => {
      ...
      (_a = mutationOptions2 == null ? void 0 : mutationOptions2.onSuccess) == null ? void 0 : _a.call(mutationOptions2, data, variables, context);
    },
    onError: (err, variables, context) => {
      var _a;
      const {
...
var useForm3 = __name2(({
  ...
  const queryDataRef = import_react85.default.useRef(void 0);
  const syncedFieldsRef = import_react85.default.useRef(/* @__PURE__ */ new Set());
  const mountedFieldsRef = import_react85.default.useRef(/* @__PURE__ */ new Set());
  const useFormCoreResult = useForm2({
    ...refineCoreProps,
  ...
  const applyValuesToFields = __name2((fieldNames, data, respectDirty = false) => {
    fieldNames.forEach((path) => {
      if (syncedFieldsRef.current.has(path)) {
        return;
      }
      if (respectDirty && get_default(dirtyFields, path)) {
        syncedFieldsRef.current.add(path);
        return;
      }
      syncedFieldsRef.current.add(path);
      if (has_default(data, path)) {
        setValue(path, get_default(data, path));
      }
    });
  }, "applyValuesToFields");
  (0, import_react85.useEffect)(() => {
    ...
    let isActive = true;
    const applyQueryValues = __name2(() => {
      if (!isActive)
        return;
  ...
  const onValuesChange = __name2((changeValues) => {
    var _a, _b;
  ...
  const handleSubmit = __name2((onValid, onInvalid) => async (e) => {
    setWarnWhen(false);
...
var useStepsForm = __name2(({
  stepsProps,
  ...rest
} = {}) => {
  const { defaultStep = 0, isBackValidate = false } = stepsProps ?? {};
  const [current, setCurrent] = (0, import_react86.useState)(defaultStep);
  const useHookFormResult = useForm3({
    ...rest
  });
  const {
    trigger,
  ...
  const gotoStep = __name2(async (step) => {
    if (step === current) {
      return;
    }
...
var useModalForm = __name2(({
  ...
  var _a, _b;
  const invalidate = useInvalidate();
  const [initiallySynced, setInitiallySynced] = import_react88.default.useState(false);
  const translate = useTranslate();
  ...
  const submit = __name2(async (values) => {
...
//# sourceMappingURL=@refinedev_react-hook-form.js.map
